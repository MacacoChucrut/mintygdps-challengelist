        ...
        <main v-else class="pack-list">
            ...
            <div class="level-container">
                <div class="level" v-if="selectedPackLevels[selectedLevel]">
                    ...
                    <LevelAuthors :creators="selectedPackLevels[selectedLevel][0].level.creators" :verifier="selectedPackLevels[selectedLevel][0].level.verifier"></LevelAuthors>
                    ...
                    <h2>Victors</h2>
                    <p v-if="selected + 1 > 50">This level fell off the Top #50. Records will no longer be accepted.</p>
                    <table class="records">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <p>
                        These are List Packs all chosen by the List staff team.
                    </p>
